...
public class PersonController{
	...
	public ModelAndView submit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean currentlyEmployed = currentlyEmployedStr.equals("Yes") ? true : false;
